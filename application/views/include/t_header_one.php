...
<?php } ?>
        ...
        <div class="header-line hidden-xs">
            <div class="container no-padding">
                ...
                <div class="col-md-2 col-sm-3 mb" ><a href=""><img src="<?php echo base_url()?>assets/website_assets/assets/images/logo2211.png" class="lima"></a></div>

                <div class="col-md-6 col-sm-4" align="right">

                <form method="post" action="" style="display: flex; width:95%">

                <input type="text" id="data_search" class="search_id" list="browsers" name="keyword" class="form-control search" placeholder="Search in mobiledarzi" onfocus="this.placeholder = ''"autocomplete="off" style="padding-left:5px;" required="">
                <span id="data"></span>
