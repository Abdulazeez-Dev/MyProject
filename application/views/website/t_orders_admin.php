                    ...
                    <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                      <thead>
                        <tr>
                          <th>SL. NO.</th>
                          <th>PRODUCT</th>
                          <th>DESIGN SELECTED</th>
                          <th>RATE</th>
                          <th>QTY</th>
                          <th>Style - OWN</th>
                          <th>STATUS</th>
                          <th>APPROVE</th>
                          <th class="disabled-sorting text-center">View All</th>
                        </tr>
                      </thead>
                      <tfoot>
                        <tr>
                      ...
                      <tbody>
                        ...
                        <tr>
                            <td><?php echo ++$key; ?></td>
                            <td><img src="<?php echo base_url()?>uploads/<?php echo get_value('tbl_product','pro_id',$value->pro_id,'pro_img'); ?>" class="card-avatar1"></td>
                            
                            <td><?php echo count($get_design_ids); ?></td>
                            <td><?php echo $value->total_rate; ?></td>
                            <td><?php echo $value->qty; ?></td>
                            <?php if(!empty($value->own_design_img)){ ?>
                            <td><img src="<?php echo base_url()?>uploads/<?php echo $value->own_design_img; ?>" class="card-avatar1"></td>
                        <?php }else{ ?>
                        	<td>Not Uploaded</td>
                        <?php } ?>
                        <td ><span class="btn <?php if($value->order_status =='PENDING'){ ?>btn-danger<?php }else{  ?>btn-success<?php }  ?>"><?php echo $value->order_status; ?></span></td>
                        	<?php if($value->order_status =='PENDING'){ ?>
                            <td><a href="<?php echo base_url()?>t_order_approve/<?php echo $value->order_id;?>" class="btn btn-link btn-danger">Approve</a> </td><?php }else{  ?><td></td>
                      <?php }  ?>
                            	<td><a href="<?php echo base_url()?>t_order_view_admin/<?php echo $value->order_id;?>" class="btn btn-link btn-danger">View</a>
                          </td>
